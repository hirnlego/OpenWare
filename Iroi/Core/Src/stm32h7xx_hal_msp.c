...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = RESONATORR_CV_Pin|MUX_Pin|MOD_LEVEL_Pin|SPEED_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = FILTERR_CV_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(FILTERR_CV_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    GPIO_InitStruct.Pin = FILTER_Pin|ECHOO_CV_Pin|AMBIENCEE_CV_Pin|AMBIENCE_DW_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ECHO_DW_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ECHO_DW_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOA, RESONATORR_CV_Pin|MUX_Pin|MOD_LEVEL_Pin|SPEED_Pin);

    HAL_GPIO_DeInit(FILTERR_CV_GPIO_Port, FILTERR_CV_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(GPIOF, FILTER_Pin|ECHOO_CV_Pin|AMBIENCEE_CV_Pin|AMBIENCE_DW_Pin);

    HAL_GPIO_DeInit(ECHO_DW_GPIO_Port, ECHO_DW_Pin);
